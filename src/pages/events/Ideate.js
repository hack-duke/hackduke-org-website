    ...
    return (
        <div id="ideate" className={"ideate"}>
            <div className={"ideate-text"}>
                ...
                <p>Ideate is a two-day conference filled with awesome speakers and workshops to explore how design and innovation interact. The designathon aims to observe how design thinking can be applied across fields, and is open to design aficionados, curious newcomers, and everyone in between!</p>
                <a href={"https://www.youtube.com/watch?v=93Lj-lYrhBg&list=PLtFr9wE3pO0Sdnpnc_yDrSe6IsODx7bIW"} rel="noreferrer" target="_blank" className={"speakers-button"} style={{color: "white"}}>Watch our 2021 speakers <i className="fas fa-arrow-right"/></a>
            </div>
