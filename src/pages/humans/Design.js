...
import arelySun from "../../graphics/team-photos/arelySun.JPG";
import yashaDoddabele from "../../graphics/team-photos/yashaDoddabele.jpg";

function Design() {
    return (
        <div>
            <p style={{ fontSize: "20px", marginBottom: "30px" }}>
                More than just making things look pretty! But we do enjoy a good
                deal of pixel-pushing...
            </p>
