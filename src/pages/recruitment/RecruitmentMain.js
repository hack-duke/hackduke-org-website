        ...
        <div id="main" className={"recruitment-bg"}>
            <div className={"recruitment-main"}>
                <div className={"recruitment-text"}>
                    ...
                    <p className={"smaller-text-box"}>We will be recruiting at the start of the Fall 2022 semester! More information will be released soon, so join our mailing list to get notified when applications are released.</p>
